        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/productos?categoria=cascos" className="text-gray-400 hover:text-white transition-colors">
                  Cascos de Seguridad
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/productos?categoria=calzado" className="text-gray-400 hover:text-white transition-colors">
                  Calzado de Seguridad
                </Link>
              </li>
              <li>
                <Link to="/productos?categoria=ropa" className="text-gray-400 hover:text-white transition-colors">
                  Ropa de Trabajo
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-400">info@protexwear.es</p>
              </div>
