...
function ProductDetailPage() {
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      // Fallback a un toast si existiera, o consola. Alert es demasiado agresivo para una UI premium.
      console.error('Error al añadir al carrito. Por favor, inténtalo de nuevo.');
    } finally {
