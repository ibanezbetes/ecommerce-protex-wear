                  ...
                  <Link key={product.id} href={`/products/${product.id}`} className="group block">
                    <div className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow border border-gray-100">
                      ...
                      <div className="p-4">
                        ...
                        <p className="mt-2 text-lg font-bold text-indigo-600">{price.toFixed(2)}€</p>
                      </div>
                    </div>
                  </Link>
                );
          ...
          {nextToken && (
            <div className="mt-12 flex justify-center">
              <button
                ...
                className="bg-white border-2 border-indigo-600 text-indigo-600 hover:bg-indigo-50 font-bold py-3 px-8 rounded-full transition-colors disabled:opacity-50"
              >
