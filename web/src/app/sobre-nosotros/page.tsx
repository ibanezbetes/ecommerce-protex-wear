            ...
            <div className="page-content">
                ...
                <section className="brands-section">
                    ...
                    <div className="brands-grid">
                        <Image src="/images/brands/3m.jpg" alt="Logo 3M" width={120} height={60} className="brand-logo" />
                        <Image src="/images/brands/Ansell.jpg" alt="Logo Ansell" width={120} height={60} className="brand-logo" />
                        <Image src="/images/brands/fal.jpg" alt="Logo Fal Seguridad" width={120} height={60} className="brand-logo" />
                        <Image src="/images/brands/Portwest.jpg" alt="Logo Portwest" width={120} height={60} className="brand-logo" />
                        <Image src="/images/brands/deltaplus.webp" alt="Logo Delta Plus" width={120} height={60} className="brand-logo brand-logo-large" />
